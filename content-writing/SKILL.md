...
description: Assist with creating and optimising text content for human consumption. Use when the user wants to write something other than code, for human consumption.
---
